...
function drawRoadCar(ctx, x, y, w, h, bodyColor, isPlayer) {
...
function render(ctx, player, enemies, powerUps, particles, roadOffset, status) {
  const W = CANVAS_W;
  const H = CANVAS_H;
...
function useGameLoop(onStateChange) {
  const canvasRef = reactExports.useRef(null);
  const statusRef = reactExports.useRef("idle");
  const playerRef = reactExports.useRef(makePlayer());
  ...
  const roadOffsetRef = reactExports.useRef(0);
  ...
  const emitState = reactExports.useCallback(() => {
    onStateChange({
  ...
  const loop = reactExports.useCallback(() => {
    ...
    if (status === "running") {
      ...
      const spawnRate = Math.max(0.012, 0.025 - scoreRef.current * 5e-6);
  ...
  const pauseGame = reactExports.useCallback(() => {
...
function Game() {
  ...
  const { canvasRef, startGame, pauseGame, resetGame } = useGameLoop(handleStateChange);
  ...
  const healthColor = healthPct > 60 ? "#00ff88" : healthPct > 30 ? "#f5c518" : "#ff3333";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-container p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-4 left-0 right-0 flex justify-between px-4 md:hidden pointer-events-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: "pointer-events-auto btn-arcade opacity-70 text-xl px-5 py-3 select-none",
            onTouchStart: () => window.dispatchEvent(
              new KeyboardEvent("keydown", {
                key: "ArrowLeft",
                bubbles: true
              })
            ),
            onTouchEnd: () => window.dispatchEvent(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "score-panel flex flex-col gap-3", "data-ocid": "game.panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-row", "data-ocid": "game.score_stat", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-widest", children: "Score" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", children: gameState.score.toLocaleString() })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-row", "data-ocid": "game.health_stat", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-widest", children: "Health" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-2.5 bg-muted rounded-full overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-row border-b-0", "data-ocid": "game.speed_stat", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs uppercase tracking-widest", children: "Speed" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", children: gameState.speedDisplay }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs", children: "km/h" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border/50" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 mt-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            className: "btn-arcade w-full",
            style: isIdle || isGameOver ? {
              background: "oklch(0.26 0.02 250)",
              color: "oklch(0.55 0.01 250)",
              cursor: "not-allowed",
              opacity: 0.5
            } : {
              background: isPaused ? "oklch(0.68 0.22 175)" : "oklch(0.55 0.19 175)",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground/70 mb-1", children: "Controls" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "← → or A/D — move sideways" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "↑ ↓ or W/S — forward / back" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Avoid enemy cars · collect power-ups" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "+20 HP" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "+50 pts" })
        ] })
      ] })
    ] }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-4", children: "Final Score" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dark min-h-screen bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Game, {}) });
}
